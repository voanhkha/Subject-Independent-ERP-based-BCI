...
global a C g ind
% a = param.a;       % the alpha coefficients
% C = param.C;       % regularization parameter(s)
% g = param.g;       % partial derivatives of the objective function w.r.t. the alphas
% ind = param.ind;     % cell array containing indices of margin, error, reserve and unlearned vectors
